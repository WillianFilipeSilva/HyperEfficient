...
namespace HyperEfficient.Services
{
    public class RegistroService : IRegistroService
    {
        ...
        {
            IEnumerable<RegistroEntity> data = await _registroRepository.GetPaged(page, pageSize) ?? new List<RegistroEntity>();
            IEnumerable<RegistroEntity> allData = await _registroRepository.GetAll() ?? new List<RegistroEntity>();
