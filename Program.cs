...
builder.Services.AddSwaggerGen
    (
     c =>
     {
         c.SwaggerDoc("v1", new OpenApiInfo { Title = "HyperEfficient API", Version = "v1", Description = "Sistema de gestão de gastos elétricos empresariais" });
...
EnsureDatabaseAndTablesCreated(builder.Services.BuildServiceProvider().GetRequiredService<IConnection>(), builder.Configuration);
